...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-3 md:w-4 md:h-5 h-6">
...
</div>
{
  togglemenu && <div className='bg-white w-1/2 md:w-1/4 md:h-full h-full rounded-md fixed top-0 right-0'>
    ...
    <div className='py-2'>
      ...
      <p className='text-base font-medium py-1 w-[150px] text-gray-500'> +91 8456789545  
+91 8456123485</p>
    </div>
    <div className='py-2'>

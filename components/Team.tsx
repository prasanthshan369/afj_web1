        ...
        <div className='container'>
            <div className="title_part">
                ...
                <div className="grid gap-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-12 py-4">
                    <h2 className='text-4xl font-bold text-black'>Our Dedicated Team <br /> Members</h2>
                    <p className='text-lg text-[#687799]'>Ever find yourself staring at your computer screen a good consulting slogan to come to mind? Oftentimes.</p>
                </div>
            </div>

...
const Services = () => {
    return (<section className='bg-[#3e3b5a] services_sec'>
        <div className='py-20'>
            <div className=' w-full rounded-sm'>
                <div className='w-full items-center flex flex-row justify-center '>
                    <h1 className=' font-semibold w-[400px]  text-center text-2xl mb-7 md:text-3xl text-[#fff]'>Serving our client across the ddiverse industries.</h1>
                </div>
